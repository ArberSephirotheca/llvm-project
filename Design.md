...
## Purpose
A **unified, language-agnostic framework** to represent and execute GPU SIMT semantics in modern C++ using MLIR + LLVM libraries. See `docs/DIALECT_DESIGN.md` for the design sketch, `docs/SimtStepDialect.md` for the `simt_step` surface.
