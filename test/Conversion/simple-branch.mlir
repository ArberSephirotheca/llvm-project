...
// CHECK:       ^bb0(%[[ENTRY_MASK:.*]]: i64, %[[ENTRY_ARG:.*]]: i32):
...
// CHECK:     "simt_struct.block"() ({
// CHECK:       ^bb0(%[[B1_MASK:.*]]: i64, %[[B1_ARG:.*]]: i32):
// CHECK:         "simt_struct.branch"(%[[B1_MASK]], %[[B1_ARG]]) {target = @block3}
// CHECK:     }) {sym_name = "block1"}
// CHECK:     "simt_struct.block"() ({
// CHECK:       ^bb0(%[[B2_MASK:.*]]: i64, %[[B2_ARG:.*]]: i32):
// CHECK:         "simt_struct.branch"(%[[B2_MASK]], %[[B2_ARG]]) {target = @block3}
// CHECK:     }) {sym_name = "block2"}
// CHECK:     "simt_struct.block"() ({
// CHECK:       ^bb0(%[[B3_MASK:.*]]: i64, %[[B3_ARG:.*]]: i32):
